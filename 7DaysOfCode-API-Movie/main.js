...
//cria uma lista com filmes como objeto, ainda sem utlizar da api
const movies = [
  {
...
function renderMovie(movie) {
  ...
  const { title, image, rating, year, description, isFavorited } = movie //atribui a movies esses atributos
